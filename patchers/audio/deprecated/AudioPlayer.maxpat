...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 935.0, 1217.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 935.0, 1290.0, 169.0, 22.0 ],
					"text" : "dict.pack spatial: 2D: footstep:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dictionary" ],
					"patching_rect" : [ 935.0, 1352.0, 240.0, 22.0 ],
					"text" : "dict.pack player1: player2: player3: player4:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "dictionary", "", "", "", "" ],
					"patching_rect" : [ 935.0, 1410.0, 96.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 499.0, 912.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 157.0, 376.0, 53.0, 91.0 ],
					"text" : "/listener \"roomtone_01.wav  -26.457 0.786\""
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 268.0, 1018.0, 103.0, 131.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 462.0, 833.0, 148.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 462.0, 753.0, 213.0, 22.0 ],
					"text" : "mc.+~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 462.0, 578.0, 88.0, 134.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 268.0, 911.0, 213.0, 22.0 ],
					"text" : "mc.+~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 381.578943729400635, 303.289470791816711, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.578943729400635, 515.578947782516479, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 670.0, 149.0, 145.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 656.0, 578.0, 88.0, 134.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 656.0, 468.421048164367676, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 268.0, 1199.0, 296.0, 64.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 1206.0, 440.0, 146.0, 22.0 ],
					"text" : "poly.spatial.player player4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 985.0, 440.0, 146.0, 22.0 ],
					"text" : "poly.spatial.player player3"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1077.631568670272827, 323.0, 155.0, 22.0 ],
					"text" : "o.route /spatial /UI /footstep"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 1248.0, 495.0, 146.0, 22.0 ],
					"text" : "poly.spatial.player player2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 50.0, 545.0, 76.0, 22.0 ],
					"text" : "route 1 2 3 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 267.578943729400635, 468.421048164367676, 146.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 668.0, 149.0, 148.57908599999999 ],
					"proportion" : 0.39,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "FullPacket" ],
					"patching_rect" : [ 268.0, 376.0, 601.0, 22.0 ],
...
,
					"patching_rect" : [ 462.0, 468.421048164367676, 79.0, 22.0 ],
					"text" : "p footsteps"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1248.0, 703.0, 88.0, 134.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1360.0, 743.0, 88.0, 134.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1360.0, 703.0, 126.0, 22.0 ],
					"text" : "mc.stereo~ @chans 6"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1248.0, 1202.0, 54.0, 22.0 ],
					"text" : "mc.dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1248.0, 323.0, 62.0, 22.0 ],
					"text" : "route stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1248.0, 366.0, 53.0, 22.0 ],
					"text" : "s stopall"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 267.647053718566895, 694.117633819580078, 103.0, 131.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1734.0, 454.0, 64.0, 22.0 ],
					"text" : "s sf_folder"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1734.0, 376.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1686.0, 221.0, 32.0, 22.0 ],
					"text" : "path"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1686.0, 177.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1686.0, 265.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 268.0, 1358.0, 54.0, 22.0 ],
					"text" : "mc.dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "FullPacket" ],
					"patching_rect" : [ 268.0, 265.0, 1244.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 26.0, 68.0, 76.0, 138.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 27.0, 17.0, 134.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 1369.5, 943.0, 1257.5, 943.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 88.0, 621.0, 59.5, 621.0 ],
					"source" : [ "obj-50", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 102.25, 621.0, 59.5, 621.0 ],
					"source" : [ "obj-50", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 73.75, 621.0, 59.5, 621.0 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-16" : [ "mc.live.gain~[6]", "2D", 0 ],
			"obj-17" : [ "mc.live.gain~[3]", "spatial", 0 ],
			"obj-2" : [ "mc.live.gain~", "mc.live.gain~", 0 ],
			"obj-27" : [ "mc.live.gain~[7]", "footsteps", 0 ],
			"obj-28" : [ "mc.live.gain~[4]", "mc.live.gain~", 0 ],
			"obj-29" : [ "mc.live.gain~[5]", "mc.live.gain~", 0 ],
			"obj-36" : [ "mc.live.gain~[8]", "player1", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
