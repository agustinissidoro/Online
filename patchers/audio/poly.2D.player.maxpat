        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 401.0, 958.0, 195.0, 22.0 ],
                    "text": "mc.*~ 1."
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 548.0, 823.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 548.0, 739.0, 151.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 401.0, 1024.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 401.0, 466.0, 212.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "multichannelsignal", "", "" ],
                    "patching_rect": [ 401.0, 519.0, 312.0, 22.0 ],
                    "text": "mcs.poly~ poly.2D.voice 4 @args #1-2D @parallel 1"
                }
            }
        ],
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-2", 1 ],
                    "midpoints": [ 557.5, 795.0, 774.5, 795.0, 774.5, 403.0, 603.5, 403.0 ],
                    "order": 0,
                    "source": [ "obj-26", 0 ]
                }
            },
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-26", 0 ],
                    "midpoints": [ 872.5, 685.0, 557.5, 685.0 ],
                    "source": [ "obj-7", 0 ]
                }
            },
            {
